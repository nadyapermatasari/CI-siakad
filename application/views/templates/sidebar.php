...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?= base_url('assets/templates')?>/index3.html" class="brand-link">
      <img src="<?= base_url('assets/templates')?>/dist/img/AdminLTELogo.png"
           alt="AdminLTE Logo"
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
              <a href="" class="nav-link <?php if($this->uri->segment(1) == 'guru') echo 'active' ?> ">
              <i class="nav-icon fas fa-user"> </i>
              <p>
                 Guru
              </p>
